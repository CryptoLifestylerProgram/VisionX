...
pkgdatadir = $(datadir)/visionXcore
pkgincludedir = $(includedir)/visionXcore
pkglibdir = $(libdir)/visionXcore
pkglibexecdir = $(libexecdir)/visionXcore
...
CONFIG_HEADER = $(top_builddir)/src/config/visionX-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/visionX-config.h.in \
...
ACLOCAL = ${SHELL} /home/tutorial/Desktop/VisionX-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/tutorial/Desktop/VisionX-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/tutorial/Desktop/VisionX-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/tutorial/Desktop/VisionX-master/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = visionX-cli
BITCOIN_DAEMON_NAME = visionXd
BITCOIN_GUI_NAME = visionX-qt
BITCOIN_TX_NAME = visionX-tx
...
COPYRIGHT_HOLDERS_FINAL = The VisionX Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = VisionX Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/tutorial/Desktop/VisionX-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = visionXcore
PACKAGE_BUGREPORT = https://github.com/NicholasAdmin/VisionX/issues
PACKAGE_NAME = VisionX Core
PACKAGE_STRING = VisionX Core 1.0.0
PACKAGE_TARNAME = visionXcore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/tutorial/Desktop/VisionX-master
abs_srcdir = /home/tutorial/Desktop/VisionX-master
abs_top_builddir = /home/tutorial/Desktop/VisionX-master
abs_top_srcdir = /home/tutorial/Desktop/VisionX-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/tutorial/Desktop/VisionX-master/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/visionXd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/visionX-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/visionX-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = VisionX-Qt.app
OSX_DMG = VisionX-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_visionX_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_visionX_coverage.info test_visionX.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/VisionX-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/visionX-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/visionX-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/visionX-config.h
$(top_srcdir)/src/config/visionX-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/visionX-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/VisionX-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/VisionX-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "VisionX-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/VisionX-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_visionX.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_visionX -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_visionX_filtered.info: test_visionX.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_visionX_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_visionX_filtered.info
...
#test_visionX_coverage.info: baseline_filtered_combined.info test_visionX_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_visionX_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_visionX_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_visionX_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_visionX.coverage/.dirstamp:  test_visionX_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_visionX.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf coverage_percent.txt test_visionX.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
