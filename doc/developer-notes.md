...
VisionX Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as VisionX Core, where everyone uses
...
pay attention to for reviewers of VisionX Core code.

General VisionX Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: VisionX Core uses tinyformat, which is type safe. Leave them out to avoid confusion
