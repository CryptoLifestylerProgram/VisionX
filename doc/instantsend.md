...
This mechanism has been integrated into Bitcore-Node-VisionX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/visionXcoin/insight-api-visionX#web-socket-api](https://github.com/visionXcoin/insight-api-visionX#web-socket-api) 
* API: [https://github.com/visionXcoin/insight-api-visionX#instantsend-transactions](https://github.com/visionXcoin/insight-api-visionX#instantsend-transactions) 
...
By default, the VisionX Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the VisionX Core daemon:
