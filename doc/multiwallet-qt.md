...
Only requiring some minor changes is visionX.cpp.
...
Changes to visionX.cpp
----------------------
visionX.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
