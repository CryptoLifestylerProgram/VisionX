/* src/config/visionX-config.h.  Generated from visionX-config.h.in by configure.  */
/* src/config/visionX-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VISIONX_CONFIG_H

#define VISIONX_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The VisionX Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "VisionX Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/VisionX/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VisionX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VisionX Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "visionXcore"
