...
{
    if(fLiteMode) return; // ignore all VisionX related functionality
...
/*
    ...
    allow endless transaction that would bloat VisionX and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("visionX-privatesend");
