...
{
public:
    /// Is the input associated with this public key? (and there is 5000 VISIONX - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of visionX.
