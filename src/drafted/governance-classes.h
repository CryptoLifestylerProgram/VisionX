 ...
 *
 *   // network
 *   CVisionXNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.visionXcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CVisionXNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CVisionXNetwork(UniValue objIn)
    {
...
// // can be under: VisionXNetwork
// //   -- signature requirements : Key1(User)
// class CVisionXNetworkVariable : public CGovernanceObject
// {
// private:
