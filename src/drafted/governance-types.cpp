...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "VisionXNetwork") type = VisionXNetwork;
    if(strType == "VisionXNetworkVariable") type = VisionXNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == VisionXNetwork) s = "VisionXNetwork";
    if(type == VisionXNetworkVariable) s = "VisionXNetworkVariable";
