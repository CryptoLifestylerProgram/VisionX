    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("VisionX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VisionX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and visionX: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About VisionX Core"), this);
    aboutAction->setStatusTip(tr("Show information about VisionX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VisionX Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VisionX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VisionX addresses"));
    ...
    openAction->setStatusTip(tr("Open a visionX: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VisionX Core help message to get a list with possible VisionX Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("VisionX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VisionX network", "", count));
}
...
{
    QString strTitle = tr("VisionX Core"); // default title
