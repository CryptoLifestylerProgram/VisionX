    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("VISIONX-light"), QVariant("light"));
    ui->theme->addItem(QString("VISIONX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("VISIONX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("VISIONX-traditional"), QVariant("trad"));
