    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("VisionX Core");
    ...
    QString copyrightTextVisionX   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The VisionX Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextVisionX);
