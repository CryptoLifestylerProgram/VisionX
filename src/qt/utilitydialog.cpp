    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("VisionX Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About VisionX Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  visionX-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the VisionX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an visionXtive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 VISIONX, 0.1 VISIONX, 1 VISIONX and 10 VISIONX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://visionXcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://visionXcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("VisionX Core is shutting down...") + "<br /><br />" +
