...
2. run visionXd with -printalert or -sendalert like this:
   /path/to/visionXd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://visionXcoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/VisionX Core:0.12.0.58/"));
