...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("VisionX Core visionX-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  visionX-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded visionX transaction") + "\n" +
              "  visionX-tx [options] -create [commands]   " + _("Create hex-encoded visionX transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded visionX transaction
